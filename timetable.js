...
// 要素が含まれているかをチェックする関数
function isElementIncluded(targetElement) {
    ...
    return new Promise((resolve, reject) => {
        ...
        .then(html => {
            ...
            tableRows.forEach(row => {
                ...
                const lectureName = row.querySelector('td[headers="worksite"] a').textContent.trim();
                const link = row.querySelector('td[headers="worksite"] a').href;
                classSchedule.push({ classCode, timeTable, lectureName, link });
            });
